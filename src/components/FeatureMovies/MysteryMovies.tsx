import {useGetMysteryMoviesQuery} from '../../redux/services/featureMoviesApi'
...
const MysteryMovies = () => {
  ...
  const {isLoading, isSuccess, isError, data: featureMovies, error} = useGetMysteryMoviesQuery()
